...
import NationalGPData from './ui/TopNationalGPData';
    ...
    <Grid container direction="column" className={classes.mainContainer}>
      ...
      <Grid item className={classes.gpContainer}> {/*----------Select Year Block-----------*/}
        <Grid container justify="flex-start" alignItems="center">
          <Grid item>
            <Typography variant="h4"><span style={{color: theme.palette.common.color1}}>Awards given to Gram Panchayats of India in the year:</span></Typography>
          </Grid>
          <Grid item>
                ...
                <CardActionArea component={Link} to={{pathname: gpData.link, state:gpData}}>
                  ...
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
                      {gpData.name} {console.log(gpData)}
                    </Typography>
